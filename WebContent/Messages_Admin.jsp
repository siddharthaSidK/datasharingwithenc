...
<%ArrayList<Bean> al = new ViewDAO().adminViewMessagesStatus(); %>
    ...
    <div id="register" class="form-1">
        ...
        <div class="col-lg-12" style="margin-bottom: 35%;">
                    <div class="section-title" style="font-size: 25px;">Messages are Not Available</div>
                    <br>
                </div>
        <%} %>
        <%if(!al.isEmpty()){ %>
                <div class="col-lg-12">
                    <div class="section-title" style="font-size: 25px;">Messages Status</div>
                    <br>
                </div> <!-- end of col -->
           </div> <!-- end of row -->
            ...
            <div class="col-lg-12">
                        <div class="form-group">
							...
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Date & Time</th>
