...
ArrayList<Bean> al = new ViewDAO().userViewOutBoxFiles(email); %>
    ...
    <div id="register" class="form-1">
        ...
        <div class="col-lg-12" style="margin-bottom: 35%;">
                    <div class="section-title" style="font-size: 25px;">OutBox is Empty</div>
                    <br>
                </div>
        <%} %>
        <%if(!al.isEmpty()){ %>
                <div class="col-lg-12">
                    <div class="section-title" style="font-size: 25px;">Sended Files</div>
                    <br>
                </div> <!-- end of col -->
           </div> <!-- end of row -->
            ...
            <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="ViewOutBoxFile_User.jsp?fid=<%=b.getFid()%>&email=<%=email%>" style="color: red;">View</a></th>
