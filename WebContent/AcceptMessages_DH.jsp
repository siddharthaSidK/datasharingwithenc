...
<%ArrayList<Bean> al = new ViewDAO().dhViewFilesForAccept(); %>
    ...
    <div id="register" class="form-1">
        ...
        <%if(!al.isEmpty()){ %>
                <div class="col-lg-12">
                    <div class="section-title" style="font-size: 25px;">User Files
                    </div>
                    <br>
                </div> <!-- end of col -->
           </div> <!-- end of row -->
            ...
            <div id="pro">
				<div id="progress"></div>
                        ...
                        <div class="form-group">
							...
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Receiver</th>
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Apply Histogram</th>
                            </tr>
                            <%for(Bean b:al){ %>
                            <tr>
                            ...
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getRmail()%></th>
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="ViewFiles_DH.jsp?fid=<%=b.getFid() %>" style="color: red;" onclick="onc();">Apply</a></th>
                            </tr>
                            <%} %>
                            </table>
                        </div>
	...
	function onc()
	{
		...
		function frame()
		{
			...
			if(width>=0 && width<=30)
				{
					val.innerHTML="Pixel shink";
				}
				if(width>=31 && width<=60)
				{
					val.innerHTML="Apply Image Sementation";
				}
