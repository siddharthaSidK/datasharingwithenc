...
<%ArrayList<Bean> al = new ViewDAO().adminViewFeedBack(); %>
    ...
    <div id="register" class="form-1">
        ...
        <div class="col-lg-12" style="margin-bottom: 35%;">
                    <div class="section-title" style="font-size: 25px;">Feedbacks are Not Available</div>
                    <br>
                </div>
        <%} %>
        <%if(!al.isEmpty()){ %>
                <div class="col-lg-12">
                    <div class="section-title" style="font-size: 25px;">Feedback</div>
                    <br>
                </div> <!-- end of col -->
           </div> <!-- end of row -->
            ...
            <div class="col-lg-12">
                        <div class="form-group">
							...
							<th style="color: white; font-family: Times New Roman; padding: 20px;">Message</th>
                            </tr>
                            <%for(Bean b:al){ %>
                            <tr>
                            ...
                            <th style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getMessage()%></th>
                            </tr>
                            <%} %>
                            </table>
                        </div>
